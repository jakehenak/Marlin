...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  22.97,  22.97 }
    #define DEFAULT_Ki_LIST {   2.50,   2.50 }
    #define DEFAULT_Kd_LIST { 52.69, 52.69 }
...
// 28v 400mm Kapton Heatbed 
#define DEFAULT_bedKp 212.28
#define DEFAULT_bedKi 40.49
#define DEFAULT_bedKd 742.01
...
// Result 9/22/2024
// Axis Z min:0.00 max:345.82
// Calibration OK                                
// .Height:341.32  Ex:-3.37  Ey:0.00  Ez:-0.84  Radius:236.81
// .               Tx:-0.32  Ty:+0.28  Tz:+0.03
// Save with M500 and/or copy to Configuration.h

// .Height:341.42  Ex:-2.96  Ey:0.00  Ez:-0.75  Radius:237.20
// .               Tx:-0.36  Ty:+0.48  Tz:-0.12


// Recv: .Height:339.71  Ex:-5.92  Ey:0.00  Ez:-1.01  Radius:235.97
// Recv: .               Tx:-0.21  Ty:+0.26  Tz:-0.05
  ...
  #define DELTA_DIAGONAL_ROD 432.9        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 339.71            // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -5.92, 0.00, -1.01 } // (mm) Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 235.97              // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -0.21, +0.26, -0.05 } // (mm) Get these values from G33 auto calibrate
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 80, 37.625, 23 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 600, 600, 600, 200, 200  }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 18000, 18000, 18000, 10000 }

//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       { 18000, 18000, 18000, 10000 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -31.60, 18.90, -3.5 }
